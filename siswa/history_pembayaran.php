                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            include "koneksi.php";
                                            $nisn = $_SESSION['nisn'];
                                            $qry_pembayaran=mysqli_query($koneksi, "select * from pembayaran join siswa on siswa.nisn=pembayaran.nisn join spp on spp.id_spp=pembayaran.id_spp where pembayaran.keterangan='lunas' AND pembayaran.nisn='$nisn' ") or die (mysqli_error($koneksi));
                                            $no=0;
