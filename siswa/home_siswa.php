...
<body>
    ...
    $jml_spp=mysqli_fetch_array($spp);

    $nisn = $_SESSION['nisn'];
    $tagihan=mysqli_query($koneksi, "select * from pembayaran where nisn='$nisn' AND keterangan = 'belum lunas'");
    $jml_tagihan=mysqli_num_rows($tagihan);
    ?>
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Selamat Datang <?=$_SESSION['nama']?> di website SPP_Sekolah</h3>
            </div>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">SPP (Bulan ini)</h6>
                                                <h6 class="font-extrabold mb-0"><?php echo $jml_spp['nominal']?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0"><?php echo $jml_tagihan?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
