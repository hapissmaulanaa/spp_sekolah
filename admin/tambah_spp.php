                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" value="Tambah SPP" name="submit" class="btn btn-primary">
                                            </div>
                                            </div>
                                            </form>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($data_spp=mysqli_fetch_array($qry_spp)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- Buka Ubah Petugas -->
                                                    <td>
                                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_edit<?php echo $data_spp['id_spp'];?>">
                                                        Ubah
                                                        </button>
                                                        
                                                        <div class="modal fade" id="modal_edit<?php echo $data_spp['id_spp'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <?php
                                                                include "koneksi.php";
                                                                $qry_get_spp=mysqli_query($koneksi,"select * from spp where id_spp = '".$id_spp."'");
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                                                    <input type="submit" value="Ubah SPP" name="submit" class="btn btn-primary">
                                                                </div>
                                                                </div>
                                                                </form>
                                                            </div>
