            ...
            <div class="col-md-5 mt-5">
                <div class="card shadow-sm p-3 border-radius-10 border-0 mt-5">
                    <div class="card-body">
                        <h4>Login</h4>
                        <!-- Masukkan nama -->
                        <form action="proses_login_petugas.php" method="post" class="mt-4">
                            <div class="form-group">
                                <input type="text" class="form-control btn-outline-theme" name="username" placeholder="Username / Email">
                            </div>
                            <!-- Masukkan password -->
